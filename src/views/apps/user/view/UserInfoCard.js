              ...
              <div className="d-flex justify-content-start">
                ...
                <div className="d-flex flex-column ml-1">
                  <div className="user-info mb-1">
                    ...
                    <CardText tag="span">{selectedUser.email}</CardText>
                  </div>
                  <div className="d-flex flex-wrap align-items-center">
                    <Button.Ripple
                      tag={Link}
                      to={`/user/edit/${selectedUser._id}`}
                      color="primary"
                    >
                      Edit
                    </Button.Ripple>
          ...
          <Col xl="6" lg="12" className="mt-2 mt-xl-0">
            <div className="user-info-wrapper">
              <div className="d-flex flex-wrap align-items-center">
                ...
                <CardText className="mb-0">{selectedUser.name}</CardText>
              </div>
              ...
              <div className="d-flex flex-wrap align-items-center my-50">
                ...
                <CardText className="mb-0">{selectedUser.country}</CardText>
              </div>
              <div className="d-flex flex-wrap align-items-center">
                <div className="user-info-title">
                ...
                <CardText className="mb-0">{selectedUser.contact}</CardText>
              </div>
            </div>
          </Col>
        </Row>
