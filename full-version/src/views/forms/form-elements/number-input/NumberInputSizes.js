...
const NumberInputSizes = () => {
  return (
    <Card>
      ...
      <CardBody>
        <CardText>
          Just like other Bootstrap Components,{' '}
          <code>&lt;NumberInput /&gt;</code> supports small and large sizing via
          setting the <code>size</code> prop to either <code>'sm'</code> or{' '}
          <code>'lg'</code>, respectively.
        </CardText>
